...
<template>
  <div
    class="top-0 inset-x-0bg-white border-y px-4 sm:px-6 md:px-8 lg:hidden dark:bg-darkmode-700 dark:border-gray-700"
  >
  ...
  >
    ...
    <nav
      class="py-6 pl-4 w-full flex flex-col flex-wrap side-nav overflow-y-hidden"
    >
